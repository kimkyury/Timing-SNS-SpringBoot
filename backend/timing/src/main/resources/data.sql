INSERT INTO members (id, email, profile_image_url, nickname, birthyear, gender)
VALUES (1, 'test@com', '/test.png', '테스터', 2000, 1),
       (2, 'test2@com', '/test.png', '테스터2', 1998, 0);
...
VALUES (1, 1, NULL, NULL, '2023-10-02', '2023-10-23', '테스트목표', '/test.png', '/test.mp4', 1);
